...
public class MultiplyLinkedLists {
    public static void main(String[] args) {
        ...
        operand1.addLast(new Integer(9));
        operand1.addLast(new Integer(9));
        operand2.addLast(new Integer(2));
        operand2.addLast(new Integer(2));
    ...
    public static boolean multiply(LinkedList<Integer> operand1, LinkedList<Integer> operand2) {
        ...
        int bothOperandsLength = operand1Len + operand2Len;
        ...
        answer.add(0);
        ListIterator<Integer> operand2Iter = bothOperands.listIterator(bothOperandsLength);
